...
class TruthDiscoveryClassifier(OpenAttack.Classifier):
    ...
    def get_prob(self, input_):
        ...
        boost_preds = self.svm_model.predict_proba(input_)
        knn_preds = self.decisionTree_model.predict_proba(input_)
        models_preds = np.array([cnn_preds, svm_preds, knn_preds])
